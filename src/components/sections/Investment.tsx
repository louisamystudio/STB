  ...
  <section className="py-16 px-4 bg-white">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        ...
        <motion.div 
          className="bg-[#F5F5F5] rounded-lg p-8 text-center shadow-md hover:shadow-lg hover:-translate-y-1 hover:border hover:border-[#737D74] transition-all duration-300"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        >
          <h3 className="font-italiana text-2xl text-[#333333] mb-3">
            Grand Total
          </h3>
          <p className="font-montserrat text-base text-[#737D74] mb-3">
